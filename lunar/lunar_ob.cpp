...
const char *str_xz[]  ={"摩羯座♑","水瓶座♒","双鱼座♓","白羊座♈","金牛座♉","双子座♊","巨蟹座♋","狮子座♌","处女座♍","天秤座♎","天蝎座♏","射手座♐"};
...
{ //某月的第几个星期几,如第2个星期一指从月首开始顺序找到第2个“星期一”
  //格式: 月(2位) + 第几个(1位) + 星期几(1位) + 类型(1位) + 起始年-结束年(9位) + 名称
  //起始年的含义与出处同公历表,见 docs/festival-origins.md
	"0150I1954-9999世界麻风日", //一月的最后一个星期日（月倒数第一个星期日）
	"0520.1914-9999国际母亲节",
	"0530I1991-9999全国助残日",
	"0630.1910-9999父亲节",
	"0730.1959-9999被奴役国家周",
	"0932I1982-9999国际和平日",
	"0940.1958-9999国际聋人节",
	"0940.1954-9999世界儿童日",
	"0950I1980-9999世界海事日",
	"1011.1986-9999国际住房日",
	"1013I1990-9999国际减轻自然灾害日(减灾日)",
	"1144I1863-9999感恩节"
};
...
{ //构造函数初始化
  int i;
  //国历节日,#表示放假日,I表示重要节日或纪念日,.表示其它日子
  //每条格式: 日(2位) + 类型(1位) + 起始年-结束年(9位) + 名称
  //起始年是这个节日第一次存在的年份(设立、首次纪念或事件发生的那一年),
  //在此之前的日期不显示该节日 —— 否则 1900 年的日历上会出现"辛亥革命纪念日"
  //之类的条目。逐条的依据与出处见 docs/festival-origins.md。
  mystl::string s = "";
   s=s+"01#1912-9999元旦|" //1月

  +"02I1997-9999世界湿地日,10.1991-9999国际气象节,14I1382-9999情人节|" //2月

  +"01.1983-9999国际海豹日,03.2000-9999全国爱耳日,05.1963-9999学雷锋纪念日,08I1921-9999妇女节,12I1928-9999植树节," //3月
  +"12.1925-9999孙中山逝世纪念日,14.1995-9999国际警察日,15I1983-9999消费者权益日,17.1929-9999中国国医节,17.1978-9999国际航海日,"
  +"21.1971-9999世界森林日,21.1966-9999消除种族歧视国际日,21.1976-9999世界儿歌日,22I1993-9999世界水日,"
  +"23I1961-9999世界气象日,24.1982-9999世界防治结核病日,25.1996-9999全国中小学生安全教育日,30.1976-9999巴勒斯坦国土日|"

  +"01I1564-9999愚人节,01.1989-9999全国爱国卫生运动月(四月),01.1992-9999税收宣传月(四月),07I1950-9999世界卫生日," //4月
  +"22I1970-9999世界地球日,23.1995-9999世界图书和版权日,24.1963-9999亚非新闻工作者日|"

  +"01#1889-9999劳动节,04I1939-9999青年节,05.1994-9999碘缺乏病防治日,08.1948-9999世界红十字日,12I1912-9999国际护士节," //5月
  +"15I1994-9999国际家庭日,17.1969-9999国际电信日,18.1977-9999国际博物馆日,"
  +"20.1990-9999全国学生营养日,23.1961-9999国际牛奶日,31I1989-9999世界无烟日|"

  +"01I1949-9999国际儿童节,05.1973-9999世界环境保护日,06.1996-9999全国爱眼日,17.1995-9999防治荒漠化和干旱日," //6月
  +"23.1948-9999国际奥林匹克日,25.1991-9999全国土地日,26I1988-9999国际禁毒日|"

  +"01I1997-9999香港回归纪念日,01I1921-9999中共诞辰,01.1985-9999世界建筑日,02.1994-9999国际体育记者日," //7月
  +"07I1937-9999抗日战争纪念日,11I1990-9999世界人口日,30.1962-9999非洲妇女日|"

  +"01I1927-9999建军节,08.1945-9999中国男子节(爸爸节)|" //8月

  +"03I1945-9999抗日战争胜利纪念,08.1966-9999国际扫盲日,08.1958-9999国际新闻工作者日,09.1976-9999毛泽东逝世纪念," //9月
  +"10I1985-9999中国教师节,14.1993-9999世界清洁地球日,16.1995-9999国际臭氧层保护日,18I1931-9999九·一八事变纪念日,"
  +"20.1989-9999国际爱牙日,27.1980-9999世界旅游日,28I1952-9999孔子诞辰|"

  +"01#1949-9999国庆节,01.1975-9999世界音乐日,01.1991-9999国际老人节,02#1949-9999国庆节假日," //10月
  +"02.1949-9999国际和平与民主自由斗争日,03#1949-9999国庆节假日,04.1931-9999世界动物日,"
  +"08.1998-9999全国高血压日,08.1998-9999世界视觉日,09.1969-9999世界邮政日,09.1874-9999万国邮联日,"
  +"10I1911-9999辛亥革命纪念日,10.1992-9999世界精神卫生日,13.1950-9999世界保健日,13.1994-9999国际教师日,"
  +"14.1970-9999世界标准日,15.1984-9999国际盲人节(白手杖节),16.1981-9999世界粮食日,17.1993-9999世界消除贫困日,"
  +"22.1991-9999世界传统医药日,24.1948-9999联合国日,31.1924-9999世界勤俭日|"

  +"07.1917-9999十月社会主义革命纪念日,08.2000-9999中国记者日,09.1992-9999全国消防安全宣传教育日,10.1946-9999世界青年节," //11月
  +"11.1988-9999国际科学与和平周(本日所属的一周),12.1866-9999孙中山诞辰纪念日,14.1991-9999世界糖尿病日,"
  +"17.1941-9999国际大学生节,17.1941-9999世界学生节,20.1980-9999彝族年,21.1980-9999彝族年,22.1980-9999彝族年,"
  +"21.1973-9999世界问候日,21.1996-9999世界电视日,29.1978-9999国际声援巴勒斯坦人民国际日|"

  +"01I1988-9999世界艾滋病日,03.1992-9999世界残疾人日,05.1985-9999国际经济和社会发展志愿人员日," //12月
  +"08.1992-9999国际儿童电视日,09.1978-9999世界足球日,10.1950-9999世界人权日,"
  +"12I1936-9999西安事变纪念日,13I1937-9999南京大屠杀(1937年)纪念日,20.1999-9999澳门回归纪念,21.1891-9999国际篮球日,"
  +"24I0336-9999平安夜,25I0336-9999圣诞节,26.1893-9999毛泽东诞辰纪念";
...
void OBA::getDayName(OB_DAY &r)
 ...
 // std::cout<<m0<<"!"<<d0<<std::endl;
  ...
  for (i=0;i<wFtv.size();i++)
  {
   ...
   if(s.substr(4,1)=="-")
   {
     if( r.y<my_stoi(s.substr(0,4)) || r.y>my_stoi(s.substr(5,4)) ) continue;
     s = s.substr(9,s.length()-9);
   }
   else if(r.y<1850) continue; //未标年限的条目按公历表的下限处理
...
{ //计算农历节日
  ...
  d=d+r.Lmc + "月" + r.Ldc;
 // std::cout<<d<<std::endl;
  //农历节日多数是岁时习俗,起源年代不可考,只有少数能落到具体年份:
  //祭祀对象受封、朝廷定制、现代立法这三类。能考据的按下面的年份起算,
  //其余的不设年限。逐条依据见 docs/festival-origins.md。
  if(r.Lleap != "闰")
  {
   ...
   if(d=="正月廿九") r.C += "送穷日 ";
   //二月二"龙抬头"之名见于元代文献
   if(d=="二月初二" && r.y>=1271) r.B += "春龙节(龙抬头) ";
   //真武(北帝)于宋大中祥符年间受封,三月三北帝诞自此成俗
   if(d=="三月初三" && r.y>=1012) r.B += "北帝诞 ";
   //妈祖(林默)卒于宋雍熙四年(987),湄洲立祠奉祀
   if(d=="三月廿三" && r.y>=987) r.B += "天后诞 妈祖诞 ";
   if(d=="四月初八") r.B += "牛王诞 ";
   //关羽明万历年间加封为帝,"关帝诞"之称自此而来
   if(d=="五月十三" && r.y>=1594) r.B += "关帝诞 ";
   //宋真宗大中祥符元年(1008)以六月六为天贶节
   if(d=="六月初六" && r.y>=1008) r.B += "姑姑节 天贶节 ";
   if(d=="七月初七") r.B += "七夕(中国情人节,乞巧节,女儿节 ) ";
   if(d=="七月十五") r.B += "中元节 鬼节";
   if(d=="九月初九") {
     r.B += "重阳节 ";
     //1989年起以重阳为敬老日,2013年《老年人权益保障法》定为法定老年节
     if(r.y>=1989) r.B += "老人节(敬老节) ";
   }
